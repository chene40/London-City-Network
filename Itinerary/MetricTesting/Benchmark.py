...
class Benchmark:
    def __init__(self):
        ...
        self.station1 = random.randint(1, 303)
    ...
    def test(self, numTests: int):
        ...
        return {
            "Avg Wall Time - A*": f"{round(A_WallTime * 1000, 5)} ms",
            "Avg Wall Time - Dijkstra's": f"{round(D_WallTime * 1000, 5)} ms",
            "Avg CPU Time - A*": f"{round(A_CPUTime * 1000, 5)} ms",
            "Avg CPU Time - Dijkstra's": f"{round(D_CPUTime * 1000, 5)} ms",
        }
